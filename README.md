...
```
the backslash `\` is used to escape the '#' sign which normally comments out everything after it but we want to use it to tell imagemagick we are going to use a hex color value as background color
